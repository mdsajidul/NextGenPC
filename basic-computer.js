    ...
    const content = {
        ...
        chapter8: `
            ...
            <ol>
                ...
                <li>'Type the location of the item' বক্সে নিম্নলিখিত কমান্ডটি লিখুন:<br>
                <code>shutdown /s /f /t 00</code>
                <ul>
        ...
        chapter9: `
            ...
            <h3>ফাইল বা ফোল্ডার আনলক করার ধাপগুলো</h3>
            <ol>
                <li>ফাইল বা ফোল্ডারের উপর রাইট-ক্লিক করুন এবং 'Properties' অপশনে যান।</li>
                <li>'Security' ট্যাবে ক্লিক করুন।</li>
                <li>'Edit' বাটনে ক্লিক করুন।</li>
        ...
        chapter10: `
            ...
            <h3>ফাইল বা ফোল্ডার আনজিপ করার ধাপগুলো:</h3>
            <ol>
                <li>ফাইলের উপর রাইট-ক্লিক করুন।</li>
